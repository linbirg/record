...
class tNoteDetail(RakeMigrate):
    ...
    def up(self):
        self.create_table(
            ...
            fd.IntField(name='note_id', desc='ref key note id'),
            ...
            fd.StatusField(name='status', desc='status'),
            fd.NoteJobField(name='job'), fd.UpdatedAtField(),
            fd.CreatedAtField())

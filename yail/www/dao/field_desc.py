...
class UserIDField(IntField):
    def __init__(self, primary_key=False, auto_increment=False, desc="用户ID(自增)"):
        super().__init__(
            name="user_id",
...
class NickNameField(StringField):
    def __init__(self, desc="nickname"):
        super().__init__(name="nickname", primary_key=False, default=None, desc=desc)


class DepartmentField(StringField):
    def __init__(self, desc="department"):
        super().__init__(name="dept", primary_key=False, default="", desc=desc)


class PasswdField(StringField):
    def __init__(self, desc="passwd"):
        super().__init__(name="password", primary_key=False, default=None, desc=desc)


class RoleIDField(IntField):
    def __init__(self, primary_key=False, desc="role_id"):
        super().__init__(
            name="role_id", primary_key=primary_key, default=None, desc=desc
        )
...
class TypeIDField(IntField):
    def __init__(self, primary_key=False, desc="type_id"):
        super().__init__(
            name="type_id", primary_key=primary_key, default=None, desc=desc
        )


class GroupNameField(StringField):
    def __init__(self, desc="group_name"):
        super().__init__(name="group_name", primary_key=False, default=None, desc=desc)
...
class NoteRiskField(StringField):
    def __init__(self, desc="risk"):
        super().__init__(name="risk", primary_key=False, default=None, desc=desc)


class NoteRiskSolveTimeField(StringField):
    def __init__(self, desc="risk_solve_time"):
        super().__init__(
            name="risk_solve_time", primary_key=False, default=None, desc=desc
        )

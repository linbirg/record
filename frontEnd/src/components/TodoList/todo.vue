<template>
  <div class="shadow">
		<input 
			...
			v-model="content"
		>
		<div class="select-input" v-if="userId == 1">
			<el-select v-model="owner" class="custom-select" placeholder="负责人">
				<el-option
			...
			<el-button type="text" @click="addTodo">提交</el-button>
		</div>
		<item
			:todo="todo"
			:userId="userId"
...
.custom-select .el-input__inner, .custom-date .el-input__inner{
  border-width: 0;
}
</style>
...
<el-card class="box-card">
  <div slot="header" class="clearfix">
    <strong><span style="padding-right:15px;">WW({{weekCount}})</span><span>{{startDate}}-{{endDate}}</span></strong>
  ...
  <el-row>
    <el-col :span="2"><a href="#" @click="loadLastWeek" style="float:right;"><i class="el-icon-d-arrow-left"></i></a></el-col>
    <el-col :span="20"><span style="padding-right: 10px"></span></el-col>
    <el-col :span="2"><a href="#" @click="loadNextWeek" style="float:left;"><i class="el-icon-d-arrow-right"></i></a></el-col>
  </el-row>
</el-card>
...
export default {
  ...
  methods: {
    ...
    */
      ...
      var date1 = new Date(y, m, d), date2 = new Date(y, 0, 1),
    ...
    loadCurWeek(userId,weekCount){
      ...
      this.post({
        url: 'note/query',
        data: {'userId':userId, 'weekCount':weekCount}
      }).then(response => {
        this.loading = false
